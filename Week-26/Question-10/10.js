// Question-10 In continuation of the 8th question, let's now explore the concept of the maximum number of listeners 
...
// 51 Note that the default maximum number of listeners might vary. Your task is to limit the number of listeners 
// to 5.
